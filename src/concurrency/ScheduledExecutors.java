...
//    scheduleWithFixedDelay();
  ...
  public static void scheduleWithFixedDelay() {
    ...
    // => previous task finishes - wait 300 msecs - start next task
...
//    schedEs.shutdown(); // If I shut it down, nothing happens
  ...
  public static void scheduleAtFixedRate() {
    ...
    //     task 3 starts at 2000msecs + (500 * 2) msecs   = 3000msecs
    //     task 4 starts at 2000msecs + (500 * 3) msecs   = 3500msecs   and so on..
    final long INITIAL_DELAY = 2000, WAIT_PERIOD_BEFORE_NEXT_TASK = 500;
    schedEs.scheduleAtFixedRate(
        () -> System.out.println("Thread id: " + Thread.currentThread().getId()),
        INITIAL_DELAY,
        WAIT_PERIOD_BEFORE_NEXT_TASK,
        TimeUnit.MILLISECONDS);
    //    schedEs.shutdown(); // If I shut it down, nothing happens
  }
}
