...
//        copyBinaryFile(false);
  ...
  public static void copyTextFile(boolean buffering){
    File src = new File ("/Users/kennethmandawe/Projects/study/java8_21/src/javaio/ReadingWritingExamples.java");
    File dest = new File ("/Users/kennethmandawe/Projects/study/java8_21/src/javaio/ReadingWritingExamples2.java");
  ...
  public static void copyBinaryFile(boolean buffering){
    ...
    File src = new File ("./out/production/java8_21/javaio/ReadingWritingExamples.class");
    File dest = new File ("./out/production/java8_21/javaio/ReadingWritingExamples2.class");
